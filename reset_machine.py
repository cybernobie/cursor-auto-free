...
class MachineIDResetter:
    ...
    def generate_new_ids(self):
        ...
        # Generate new machineId (64 hex characters)
        machine_id = hashlib.sha256(os.urandom(32)).hexdigest()

        # Generate new macMachineId (128 hex characters)
    ...
    def reset_machine_ids(self):
        ...
        try:
            ...
            if not os.access(self.db_path, os.R_OK | os.W_OK):
                ...
                print(
                    f"{Fore.RED}{EMOJI['ERROR']} If you have used go-cursor-help to modify the ID; please change the file to writable: {self.db_path} {Style.RESET_ALL}"
                )
                return False
